...
class ChangeOrganisationContactDetailsHelper(userAnswers: UserAnswers, countryListFactory: CountryListFactory)(implicit messages: Messages) {
  ...
  def changeOrganisationSecondContactName: Option[SummaryListRow] = OrganisationSecondContactNameSummary.row(userAnswers)
  ...
  def changeOrganisationSecondaryContactDetails: Seq[SummaryListRow] = Seq(
