...
class UnableToChangeBusinessControllerSpec extends ControllerMockFixtures {
  ...
  "UnableToChangeBusiness Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        implicit val request = FakeRequest(GET, controllers.organisation.routes.UnableToChangeBusinessController.onPageLoad().url)
