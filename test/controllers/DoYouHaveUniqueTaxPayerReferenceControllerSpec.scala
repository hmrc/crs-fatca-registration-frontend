...
class DoYouHaveUniqueTaxPayerReferenceControllerSpec extends SpecBase with MockitoSugar {
  ...
  private lazy val loadRoute   = routes.DoYouHaveUniqueTaxPayerReferenceController.onPageLoad(NormalMode).url
  private lazy val submitRoute = routes.DoYouHaveUniqueTaxPayerReferenceController.onSubmit(NormalMode).url
